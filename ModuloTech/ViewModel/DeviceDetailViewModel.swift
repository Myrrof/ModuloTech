...
class DeviceDetailViewModel {
    ...
    func onClickDelete(completion: () -> ()) {
        switch productType {
        case "Light": UserDatabase.shared.deleteLightById(id: id, completion: { completion() })
        case "RollerShutter": UserDatabase.shared.deleteRollerShutterById(id: id, completion: { completion() })
        case "Heater": UserDatabase.shared.deleteHeaterById(id: id, completion: { completion() })
        default: break
        }
    }
